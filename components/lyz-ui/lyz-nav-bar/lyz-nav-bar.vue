						...
						<view class="header_left_info" :class="{ 'header_btnMongol':isTwoBtn,'header_colorWhite_btnMongol': isWhite && isTwoBtn}"
						 v-if="back || $slots.left || home">
							<view class="header_left_back" :class="{'header_btnMongol_left_back':isTwoBtn}" v-if="back && !firstPage" @click="onBackPage">
								<image class="header_icon" v-if="isWhite" src="/static/icon/nav-left.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/icon/nav-left.png" mode="aspectFit"></image>
							</view>
							...
							<view class="header_left_home" :class="{'header_btnMongol_left_home':isTwoBtn}" v-if="(firstPage && back) || home"
							 @click="onBackHome">
								<image class="header_home_icon" v-if="isWhite" src="/static/tabBar/home.png" mode="aspectFit"></image>
								<image class="header_home_icon" v-else src="/static/tabBar/home.png" mode="aspectFit"></image>
							</view>
						</view>
					</slot>
...
<style lang="scss">
	...
	.header_shadow {
		...
		box-shadow: 0rpx 4rpx 8rpx 0rpx rgba(51,51,51,0.0800);
	}
